...
ScriptGenerator.prototype.generateAspNetCoreDeploymentScript = function ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__8(_) { var nuget_35_renamed, nugetRestoreArgs, files, webProjFiles, msbuildArguments, dotnetpublishArguments, options, buildAndPublish, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__8", line: 285 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__8, 0, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__8() {
    ...
    nuget_35_renamed = "nuget3_5.exe"; return (function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__8(__then) {
      ...
      if ((__this.solutionPath && !(__this.projectPath.endsWith(".csproj")))) {
        ...
        if ((__this.scriptType == ScriptType.batch)) {
          ...
          nugetRestoreArgs = ("%DEPLOYMENT_SOURCE%\\" + __this.solutionPath); }
         else {
          msbuildArguments = (("\"$DEPLOYMENT_SOURCE\\" + __this.solutionPath) + "\" /nologo /verbosity:m /p:AutoParameterizationWebConfigConnectionStrings=false`;Configuration=Release`;UseSharedCompilation=false` $SCM_BUILD_ARGS");
          dotnetpublishArguments = (("\"$DEPLOYMENT_SOURCE\\" + __this.projectPath) + "\" /nologo /verbosity:m /t:GatherAllFilesToPublish /p:AutoParameterizationWebConfigConnectionStrings=false`;Configuration=Release`;UseSharedCompilation=false`;PublishOutputPathNoTrailingSlash=\"$DEPLOYMENT_TEMP\" $SCM_BUILD_ARGS");
          nugetRestoreArgs = ("$DEPLOYMENT_SOURCE\\" + __this.solutionPath); } ;
        ...
        return __this.generateAspNetCoreScript("aspnet.core.msbuild.template", options, __cb(_, __frame, 44, 4, __then, true)); } else {


        nugetRestoreArgs = ((" restore \"" + (((__this.solutionPath) ? __this.solutionPath : __this.projectPath))) + "\"");


        if (__this.projectPath.endsWith(".csproj")) {

          nugetRestore = ("nuget.exe" + nugetRestoreArgs);
          if ((__this.scriptType == ScriptType.batch)) {
            buildAndPublish = (("\"%MSBUILD_PATH%\" \"" + fixPathSeperatorToWindows(__this.projectPath)) + "\" /t:Publish /p:PublishDir=\"%DEPLOYMENT_TEMP%\";Configuration=Release %SCM_BUILD_ARGS%"); }
           else {
            buildAndPublish = (("\"$MSBUILD_PATH\" \"" + fixPathSeperatorToWindows(__this.projectPath)) + "\" /t:Publish /p:PublishDir=\"$DEPLOYMENT_TEMP\";Configuration=Release $SCM_BUILD_ARGS"); } ; }
          ...
          if ((__this.scriptType == ScriptType.batch)) {
            buildAndPublish = (("dotnet publish \"" + fixPathSeperatorToWindows(__this.projectPath)) + "\" --output \"%DEPLOYMENT_TEMP%\" --configuration Release"); }
           else {
            buildAndPublish = (("dotnet publish \"" + fixPathSeperatorToWindows(__this.projectPath)) + "\" --output \"$DEPLOYMENT_TEMP\" --configuration Release"); } ; } ;


        return __this.generateAspNetCoreScript("aspnet.core.template", {
          buildAndPublish: buildAndPublish,
          restore: nugetRestore }, __cb(_, __frame, 67, 4, __then, true)); } ; })(_); });};




ScriptGenerator.prototype.generateDnxConsoleAppDeploymentScript = function ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__9(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__9", line: 359 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__9, 0, __frame, function __$ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__9() {
    if ((__this.scriptType != ScriptType.batch)) {
...
ScriptGenerator.prototype.generateDotNetConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__10(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__10", line: 373 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__10, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__10() {
    argNotNull(__this.projectPath, "projectPath");
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__11(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__11", line: 418 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__11, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__11() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__11(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__12(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__12", line: 443 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__12, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__12() {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__13(templateFileName, options, _) { var lowerCaseScriptType, solutionDir, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__13", line: 457 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__13, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__13() {
    argNotNull(templateFileName, "templateFileName");
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 564 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
